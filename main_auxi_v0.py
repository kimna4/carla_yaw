...
parser.add_argument('--train-dir', default="/SSD1/datasets/carla/additional_db/gen_data_brake/",
                    type=str, metavar='PATH', help='training dataset')
parser.add_argument('--eval-dir', default="/SSD1/datasets/carla/additional_db/gen_data_brake_val/",
